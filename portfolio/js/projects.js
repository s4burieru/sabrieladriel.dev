    ...
    <div class="group flex flex-col h-full min-h-110 sm:min-h-120 bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-white/30 hover:bg-white/10 transition">
      ...
      <div class="relative w-full aspect-video rounded-none overflow-hidden group-hover:border-white/50 transition">
        ...
        <div class="absolute top-3 sm:top-4 right-3 sm:right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition duration-300 flex-wrap">
          ${project.website !== '#' ? `<a href="${project.website}" class="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center bg-white text-black rounded-full font-semibold text-xs sm:text-sm hover:bg-gray-100 transition" title="View Website"><img src="./assets/icons/web.svg" alt="Source" class="w-5 h-5" /></a>` : ''}
