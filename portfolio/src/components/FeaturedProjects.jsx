        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {projects.length > 0
            ? projects.map((project) => (
                <div
                  key={project.id}
                  className="group flex flex-col h-full bg-white/5 border border-white/10 rounded-2xl backdrop-blur-lg overflow-hidden hover:border-white/30 hover:bg-white/10 transition"
                >
                  {/* Thumbnail */}
